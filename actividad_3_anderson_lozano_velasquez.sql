...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='Este campo contendra los registros de ventas del producto ';
...
INSERT INTO `customers` (`id`, `name`, `premium`, `phone_number`) VALUES
	(1, 'Diana Suluaga Cartago', b'1', '3021235545'),
	(2, 'Katalina Gerico Marcela', b'0', '3065535656'),
	(3, 'Kendri Alejandra Ibargüin', b'1', '54126532115');
...
-- Volcando datos para la tabla tienda_deportiva_el_podio.payment_forms: ~2 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='este campo contendra el producto que se a vendido';
...
INSERT INTO `products` (`id`, `name`, `size`, `imported`, `price`) VALUES
	(1, 'roller skates', '39', b'1', 70000),
	(2, 'helmets', 'L', b'0', 95100),
	(3, 'weight vest', '80', b'1', 524000);
...
CREATE TABLE IF NOT EXISTS `sales` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='Este campo contendra los datos en que se hizo la venta';

-- Volcando datos para la tabla tienda_deportiva_el_podio.sales: ~3 rows (aproximadamente)
DELETE FROM `sales`;
INSERT INTO `sales` (`id`, `date`, `value`, `product_id`, `payment_form_id`, `customer_id`) VALUES
	(1, '2022-06-12', 95100, 2, 3, 2),
	(2, '2022-06-13', 70000, 1, 2, 1),
	(3, '2022-06-14', 524000, 3, 1, 3);
